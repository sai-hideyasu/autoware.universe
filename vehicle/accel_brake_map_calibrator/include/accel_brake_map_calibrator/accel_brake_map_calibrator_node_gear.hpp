...
class AccelBrakeMapCalibratorGear : public rclcpp::Node
{
private:
  ...
  GearReport::ConstSharedPtr gear_ptr_;
  ...
  void callbackGear(const GearReport::ConstSharedPtr msg);
  ...
  static constexpr unsigned int num_debug_values_ = 15;
...
public:
  explicit AccelBrakeMapCalibratorGear(const rclcpp::NodeOptions & node_options);
};
